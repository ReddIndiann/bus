...
export default function Home() {
  ...
  return (
    <>
      ...
      >
        <div className="bg-transparent text-white md:p-10 lg:p-20 absolute left-0 w-full md:w-3/4 lg:w-3/4 px-10 pb-4">
        ...
        <div className="container mx-auto px-4">
          ...
          <Link href="/Announcements/Sub" passHref>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {newsItems.map((news) => (
                <div key={news.id} className="bg-white shadow-md rounded-lg overflow-hidden flex flex-row sm:flex-col">
                  <div className="w-1/3 sm:w-full">
                    <Image src={news.image} alt={news.title} width={400} height={250} className="w-full h-full object-cover"/>
                  </div>
                  <div className="w-2/3 sm:w-full p-4">
